...
<jsp:include page="../layout/header.jsp" />
	<div class="container-sm p-5 boardList">
		<!-- search -->
		<div class="container-fluid m-2">
			<form class="d-flex justify-content-end" role="search" action="/board/list" method="get">
				<div class="inputBx">
					<span></span>
		        ...
		        <div class="inputBx">
			        <button type="submit" class="filledBg">
			          <span></span>
					  Search
							...
							<td>
								<a href="/board/detail?bno=${b.bno }" style="text-decoration: none;">
									...
									<c:if test="${b.fileQty ne 0 }">
										...
										<span class="badge rounded-fill text-primary">[${b.fileQty}]</span>
									</c:if>
									<c:if test="${b.cmtQty > 0 }">
										<span class="badge rounded-fill text-warning">[${b.cmtQty}]</span>
									</c:if>
								</a>
							</td>
							<td>${b.writer }</td>
		...
		<nav aria-label="Page navigation example">
		  <ul class="pagination justify-content-center">
		    ...
		    <c:forEach begin="${ph.startPage }" end="${ph.endPage }" var="i">
			    <li class="page-item"><a class="page-link ${i == param.pageNo || (i==1 && param.pageNo == undefined)? 'active':'' }" href="/board/list?pageNo=${i }&qty=${ph.pgvo.qty }&type=${ph.pgvo.type}&keyword=${ph.pgvo.keyword}">${i }</a></li>
		    </c:forEach>
